...
bool RobotInterfaceDreamer::read(controlit::RobotState & latestRobotState, bool block)
{
    ...
    latestRobotState.setJointPosition(5, DEG_TO_RAD(shm_status.right_arm.theta[3]));
    latestRobotState.setJointPosition(6, DEG_TO_RAD(shm_status.right_arm.theta[4]));
    latestRobotState.setJointPosition(7, DEG_TO_RAD(shm_status.right_arm.theta[5]));
    latestRobotState.setJointPosition(8, DEG_TO_RAD(shm_status.right_arm.theta[6]));
    ...
    latestRobotState.setJointVelocity(5, DEG_TO_RAD(shm_status.right_arm.thetadot[3]));
    latestRobotState.setJointVelocity(6, DEG_TO_RAD(shm_status.right_arm.thetadot[4]));
    latestRobotState.setJointVelocity(7, DEG_TO_RAD(shm_status.right_arm.thetadot[5]));
    latestRobotState.setJointVelocity(8, DEG_TO_RAD(shm_status.right_arm.thetadot[6]));
    ...
    latestRobotState.setJointEffort(5, 1.0e-3 * shm_status.right_arm.torque[3]);
    latestRobotState.setJointEffort(6, 1.0e-3 * shm_status.right_arm.torque[4]);
    latestRobotState.setJointEffort(7, 1.0e-3 * shm_status.right_arm.torque[5]);
    latestRobotState.setJointEffort(8, 1.0e-3 * shm_status.right_arm.torque[6]);
...
bool RobotInterfaceDreamer::write(const controlit::Command & command)
{
    ...
    shm_cmd.right_arm.tq_desired[3] = 1e3 * cmd[5];
    shm_cmd.right_arm.tq_desired[4] = 1e3 * cmd[6];
    shm_cmd.right_arm.tq_desired[5] = 1e3 * cmd[7];
    shm_cmd.right_arm.tq_desired[6] = 1e3 * cmd[8];
