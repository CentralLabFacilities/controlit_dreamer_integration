...
class Demo1_ProductDisassembly:
    ...
    def createTrajectories(self):
        ...
        self.trajGoToReady = Trajectory.Trajectory("GoToReady", 10.0)
        ...
        # ==============================================================================================
        self.trajGrabTube = Trajectory.Trajectory("GrabTube", 5.0)
        ...
        # ==============================================================================================        
        self.trajGrabValve = Trajectory.Trajectory("GrabValve", 5.0)
        ...
        # ==============================================================================================        
        self.trajRemoveValve = Trajectory.Trajectory("RemoveValve", 5.0)
        ...
        # ==============================================================================================        
        self.trajRemoveLeftHand = Trajectory.Trajectory("RemoveLeftHand", 5.0)
        ...
        # ==============================================================================================        
        self.trajRemoveRightHand = Trajectory.Trajectory("RemoveRightHand", 5.0)
        ...
        # ==============================================================================================        
        self.trajGoToIdle = Trajectory.Trajectory("GoToIdle", 10.0)
