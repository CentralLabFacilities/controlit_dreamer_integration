...
class Demo1_ProductDisassembly:
    ...
    def grabMetalTube(self):
        ...
        rightHandCartesianWP.append([0.3389148482614625, -0.1999877561113994, 1.0553245414406363]) # Added for new location of object
        ...
        rightHandOrientationWP.append([0.33780404625791594, -0.9373624670010027, -0.08508837634820657]) # Added for new location of object
    ...
    def grabRubberValve(self):
        ...
        rightHandPosition = [0.3389148482614625, -0.1999877561113994, 1.0553245414406363]
        rightHandOrientation = [0.33780404625791594, -0.9373624670010027, -0.08508837634820657]
        ...
        # leftHandCartesianWP.append([0.27, 0.26, 1.055])
        leftHandCartesianWP.append([0.3438221101707007, 0.18023636633138734, 1.1253179263375812]) # Added for new location of object
        ...
        leftHandOrientationWP.append([-0.05439592553779897, -0.02529898802137535, 0.9981989002648624]) # Added for new location of object
    ...
    def liftRubberValve(self):
        """
        Executes the trajectory lifts the rubber valve and positions it over the left box.
        """
        ...
        rightHandCartesianWP.append(rightHandPosition)
        rightHandOrientationWP.append(rightHandOrientation)
        leftHandCartesianWP.append([0.3438221101707007, 0.18023636633138734, 1.1253179263375812])
        leftHandOrientationWP.append([-0.05439592553779897, -0.02529898802137535, 0.9981989002648624])
        jPosWP.append([0.09590536736161434, 0.09590536736161434, 
                       0.002794296425643595, 0.2835844757183357, -0.18807469031404708, 1.6100747424098305, 0.11839413877386204, 0.248941084731985, -0.9437127120955863, 
        ...
        # leftHandCartesianWP.append([0.32158564924245914, 0.24601433254693544, 1.1799905326490339])
        leftHandCartesianWP.append([0.27, 0.26, 1.13])
        leftHandCartesianWP.append([0.41886442974443455, 0.3094769056991296, 1.2627290241255107])
        leftHandCartesianWP.append([0.48277345185719983, 0.3657639673352834, 1.300190357003811])
        leftHandCartesianWP.append([0.5243759641170038, 0.4270759618427376, 1.2178245652500823])

        leftHandOrientationWP.append([-0.24277288830065594, 0.013363425163328217, 0.969991104894298])
        leftHandOrientationWP.append([-0.4817466305582503, 0.11456662528305327, 0.8687891990103382])
        leftHandOrientationWP.append([0.07967527065403097, -0.45239039250041857, 0.8882537835661182])
        leftHandOrientationWP.append([0.48603077389668553, -0.31209439694412844, 0.8163156094437184])
        ...
        if ENABLE_USER_PROMPTS:
            index = raw_input("Lift rubber valve? Y/n\n")
            if index == "N" or index == "n":
                return False  # quit
    ...
    def liftLeftArmOutOfBox(self):
        """
        Executes the trajectory that lifts the left hand out of the left box.
        """
        ...
        # This is the last configuration of the liftRubberValve trajectory
        rightHandCartesianWP.append(rightHandPosition)
        rightHandOrientationWP.append(rightHandOrientation)
        leftHandCartesianWP.append([0.5243759641170038, 0.4270759618427376, 1.2178245652500823])
        leftHandOrientationWP.append([0.48603077389668553, -0.31209439694412844, 0.8163156094437184])
        ...
        leftHandCartesianWP.append([0.5243759641170038, 0.4270759618427376, 1.26])
        leftHandCartesianWP.append([0.5660859116491781, 0.30329916134206, 1.3])
        leftHandCartesianWP.append([0.5331769484913014, 0.33551507563836863, 1.4390766724027195])
        leftHandCartesianWP.append([0.3717325873708269, 0.33162348107300504, 1.2861188455308357])
        leftHandCartesianWP.append([0.2543733897875106, 0.29467616558006343, 1.233988175199949])
        leftHandCartesianWP.append([0.27493886862283073, 0.2888653839749931, 1.1563093155705326])

        leftHandOrientationWP.append([0.41901011506443336, 0.16729650677786373, 0.892436217493225])
        leftHandOrientationWP.append([0.24882086601246373, 0.09105473725282154, 0.9642599294073292])
        leftHandOrientationWP.append([0.2330872682336373, 0.02584978972683424, 0.9721121919606085])
        leftHandOrientationWP.append([0.3801523299067776, -0.11787496189445643, 0.9173819811969435])
        leftHandOrientationWP.append([0.40154404672474, 0.16101160886995855, 0.9015750885805506])
    ...
    def placeTubeInBox(self):
        """
        Executes the trajectory that puts the metal tube in the right box.
        """
        ...
        # Left hand does not move
        leftHandPosition = [0.27493886862283073, 0.2888653839749931, 1.1563093155705326]
        leftHandOrientation = [0.40154404672474, 0.16101160886995855, 0.9015750885805506]

        # This is the last configuration of the liftLeftArmOutOfBox trajectory
        rightHandCartesianWP.append([0.3389148482614625, -0.1999877561113994, 1.0553245414406363])
        rightHandOrientationWP.append([0.33780404625791594, -0.9373624670010027, -0.08508837634820657])
        leftHandCartesianWP.append(leftHandPosition)
        leftHandOrientationWP.append(leftHandOrientation)
        jPosWP.append([0.1059981788687132, 0.1059981788687132,
                       0.055975443762288614, -0.005876388217591141, 0.30103619726669223, 2.0797926209567303, 0.10425306276346165, -0.8026267888701227, -0.7932278546960052, 
        ...
        rightHandCartesianWP.append([0.27745790782530205, -0.24799403868875466, 1.0856900685019806])
        rightHandCartesianWP.append([0.22994174073996312, -0.33516799382172185, 1.157388306768947])
        rightHandCartesianWP.append([0.3561326251338532, -0.33946713949697493, 1.2243517460872133])
        rightHandCartesianWP.append([0.46390462610893946, -0.293787775740201, 1.2749991528785545])
        rightHandCartesianWP.append([0.5379763192787382, -0.2969524135307482, 1.2642177926977944])

        rightHandOrientationWP.append([0.06443474030825493, 0.2076489934596236, 0.8182663381789003])
        rightHandOrientationWP.append([0.06429600040269182, 0.20627739883206447, 0.8182111373492508])
        rightHandOrientationWP.append([0.0642089487626879, 0.20619008182347112, 0.8181108838396054])
        rightHandOrientationWP.append([0.06461697040941353, 0.20621809164001692, 0.8180000562311803])
        rightHandOrientationWP.append([0.0649257474773032, 0.20623027660103616, 0.8180329664395322])
    ...
    def removeRightHandFromBox(self):
        """
        Executes the trajectory that removes the right hand from the right box.
        """
        ...
        rightHandCartesianWP.append([0.5267938178777718, -0.3379240595874126, 1.3287458373790948])
        rightHandCartesianWP.append([0.41419485122905375, -0.31574762274337476, 1.2753847374072789])
        rightHandCartesianWP.append([0.32017232822372593, -0.2705999134573017, 1.156529294894129])
        rightHandCartesianWP.append([0.24477144224239697, -0.31430061008380034, 1.08248780350051])

        rightHandOrientationWP.append([0.07391321441730378, 0.2058378093754104, 0.8180072409756564])
        rightHandOrientationWP.append([0.07388394407368064, 0.20575418359715958, 0.8179989870031715])
        rightHandOrientationWP.append([0.07136041758260608, 0.20565020252936395, 0.8167564895722128])
        rightHandOrientationWP.append([0.07200104200391998, 0.20097007187421068, 0.8166377080331908])
    ...
    def goToIdlePosition(self):
        ...
        # This is the last configuration of the removeRightHandFromBox trajectory
        rightHandCartesianWP.append([0.24477144224239697, -0.31430061008380034, 1.08248780350051])
        rightHandOrientationWP.append([0.07200104200391998, 0.20097007187421068, 0.8166377080331908])
        leftHandCartesianWP.append([0.27493886862283073, 0.2888653839749931, 1.1563093155705326])
        leftHandOrientationWP.append([0.40154404672474, 0.16101160886995855, 0.9015750885805506])
